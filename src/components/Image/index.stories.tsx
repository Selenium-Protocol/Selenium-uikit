...
export const TokenImages: React.FC = () => {
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        const src = `https://selenium.money/images/tokens/${token.address[56]}.svg`;
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        ...
        const primarySrc = `https://selenium.money/images/tokens/${token.address[56]}.svg`;
        const secondarySrc = `https://selenium.money/images/tokens/${tokens[randomTokenIndex].address[56]}.svg`;
